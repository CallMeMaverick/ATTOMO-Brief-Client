...
async function fetchUser(userId) {
    try {
        const response = await fetch(`https://attomo-brief-api-solitary-darkness-4773.fly.dev/user/${userId}`, {
            method: "GET",
            headers: {
...
async function fetchBookedAccommodations(fetchBookedAccommodationsIds) {
    ...
    try {
        for (let i = 0; i < fetchBookedAccommodationsIds.length; i++) {
            const response = await fetch(`https://attomo-brief-api-solitary-darkness-4773.fly.dev/accommodation/${fetchBookedAccommodationsIds[i]}`, {
                method: "GET",
                headers: {
                    "Content-Type": "application/json",
...
export async function dismissBooking(accommodationId) {
    ...
    try {
        const response = await fetch(`https://attomo-brief-api-solitary-darkness-4773.fly.dev/accommodation/${accommodationId}/dismissBooking`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                "Authorization": `Bearer ${localStorage.getItem("token")}`
