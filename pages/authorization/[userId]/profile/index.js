...
async function updateUser(userId, updatedData) {
    try {
        const response = await fetch(`https://attomo-brief-api-solitary-darkness-4773.fly.dev/user/update/${userId}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json",
                "Authorization": `Bearer ${localStorage.getItem("token")}`
        ...
        <div className="max-w-md mx-auto mt-10">
            {editMode ? (
                ...
                <div className="bg-white p-6 rounded-lg shadow-lg">
                    ...
                    <p className="mb-2"><span className="font-bold">Status:</span> <span className="italic font-bold text-cyan-500">{user.role || " "}</span></p>
