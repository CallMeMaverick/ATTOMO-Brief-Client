...
export async function fetchBooker(bookerId) {
    try {
        const response = await fetch(`https://attomo-brief-api-solitary-darkness-4773.fly.dev/booker/${bookerId}`, {
            method: "GET",
            headers: {
                "Content-Type": "application/json",
                "Authorization": localStorage.getItem("token")
...
export async function book(userId, accommodationId) {
    try {
        const response = await fetch(`https://attomo-brief-api-solitary-darkness-4773.fly.dev/accommodation/${userId}/${accommodationId}/book`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
